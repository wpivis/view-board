...
var Nopixel =  function(configPath) {
	...
	self.setPixel = function(x, y, colorString) {
		...
		if (colorObj.isValid()) {
			...
			port.write(new Buffer.from([startBit,104,toIndex(x,y),colorRGB.r,colorRGB.g,colorRGB.b,endBit]), function(err) {
				if (err) {
	...
	self.update = function() {
		port.write(new Buffer.from([startBit, 105, endBit]), function(err) {
			if (err) {
				return console.log("Error on write: ", err.message);
			}
		})
